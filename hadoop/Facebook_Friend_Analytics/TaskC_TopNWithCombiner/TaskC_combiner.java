...
public class TaskC_combiner {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if(args.length !=2){
            ...
            System.err.println("Usage: TaskC_combiner <input path> <output path>");
            System.exit(0);
        }
        ...
        Job job1 = Job.getInstance(conf1, "TaskC1_combiner");

        job1.setJarByClass(TaskC_combiner.class); //driver
        ...
        Job job2 = Job.getInstance(conf2, "TaskC2_combiner");

        job2.setJarByClass(TaskC_combiner.class); //driver
